...
class LoadModelDemo {
  ...
  _LoadAnimatedModel() {
    ...
    loader.setPath('./resources/dance2/');
    loader.load('PaladinNordstrom.fbx', (fbx) => {
      ...
      anim.setPath('./resources/dance2/');
      anim.load('Hop.fbx', (anim) => {
  ...
  _LoadModel() {
    const loader = new FBXLoader();
    loader.load('./resources/dance2/thing.glb', (gltf) => {
...
// if (Sonorous && Sonorous.isSupported()) {
    // const sonor = window.Sonorous.addSonor('./assets/sound.mp3');
    const sonor = new Audio('./assets/sound.mp3');
